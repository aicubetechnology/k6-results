...
`;
  ...
  return `# Resultado do Teste de Fumaça: smoke-get-tenant-stats-apikey (B200)
...
Os resultados mostram o desempenho e a confiabilidade do servidor B200 ao processar requisições de obtenção de estatísticas de tenant.
`;
}