...
function generateSummaryMarkdown(data, timestamp) {
  ...
  return `# Resultado do Teste de Stress: stress-get-tenant-stats-apikey
...
Este teste de stress simulou até 500 usuários virtuais fazendo consultas simultâneas ao endpoint \`/admin/tenant/${TENANT_ID}/stats\`. 
