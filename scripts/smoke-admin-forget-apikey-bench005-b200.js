...
import { API_BASE_URL, getHeaders, TENANT_ID, getForgetPayload } from './utils-apikey-bench005-b200.js';
...
`;
  ...
  return `# Resultado do Teste de Fumaça: smoke-admin-forget-apikey (B200)
...
Os resultados mostram o desempenho e a confiabilidade do servidor B200 ao processar requisições de esquecimento.
`;
}