...
import { API_BASE_URL, getHeaders, getRetrievePayload } from './utils-apikey-b200.js';
...
export function handleSummary(data) {
  ...
  const scriptName = 'smoke-retrieve-apikey-compare';
...
`;
  ...
  return `# Resultado do Teste de Fumaça: smoke-retrieve-apikey-compare (B200)
...
Este teste foi executado com os mesmos parâmetros utilizados no teste do servidor H100, permitindo uma comparação direta do desempenho. 
