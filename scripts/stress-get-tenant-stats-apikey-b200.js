...
import { API_BASE_URL, getHeaders, TENANT_ID } from './utils-apikey-b200.js';
...
export function handleSummary(data) {
  ...
  const scriptName = 'stress-get-tenant-stats-apikey';
...
`;
  ...
  return `# Resultado do Teste de Stress: stress-get-tenant-stats-apikey (B200)
...
Este teste de stress simulou até 500 usuários virtuais fazendo consultas simultâneas ao endpoint \`/admin/tenant/${TENANT_ID}/stats\` no servidor B200. 
