...
import { API_BASE_URL, getHeaders, getRetrievePayload, checkStatus } from './utils.js';
...
export default function() {
  ...
  if (res.status === 200) {
    ...
    check(body, {
      'matches property exists': (r) => r.matches !== undefined,
      'source property exists': (r) => r.source !== undefined,
    });
    console.log(`Retrieved ${body.matches ? body.matches.length : 0} memory matches`);
  }
