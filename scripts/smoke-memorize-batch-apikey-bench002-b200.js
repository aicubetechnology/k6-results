...
import { API_BASE_URL, getHeaders, TEST_MEMORY_TEXTS, TENANT_ID, TEST_AGENT_ID } from './utils-apikey-bench002-b200.js';
...
export function handleSummary(data) {
  ...
  const baseDir = 'results/bench-session-002/b200';
...
`;
  ...
  return `# Resultado do Teste de Fumaça: smoke-memorize-batch-apikey (B200)
...
Os resultados mostram o desempenho e a confiabilidade do servidor B200 ao processar requisições de memorização em lote.
`;
}