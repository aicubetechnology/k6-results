...
`;
  ...
  return `# Resultado do Teste de Carga: load-get-tenant-stats-apikey (H100)
...
Este teste de carga avalia o desempenho do endpoint \`/admin/tenant/{tenant_id}/stats\` do servidor H100 sob carga moderada. Os resultados mostram como o servidor responde ao aumento gradual de usuários virtuais, permitindo analisar a escalabilidade e estabilidade do sistema.
