...
import { API_BASE_URL, getHeaders, getMemorizePayload, checkStatus } from './utils-apikey-b200.js';
...
export function handleSummary(data) {
  ...
  // Usamos o tipo "smoke" para este teste
...
`;
  ...
  return `# Resultado do Teste Smoke: smoke-memorize-apikey (B200)
