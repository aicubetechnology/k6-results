...
import { API_BASE_URL, getHeaders, TEST_MEMORY_TEXTS, TENANT_ID, TEST_AGENT_ID } from './utils-apikey-bench003-b200.js';
...
export function handleSummary(data) {
  ...
  const baseDir = 'results/bench-session-003/b200';
