...
export const API_KEY = 'qube_78030d84f9ed434a83494780ec3bc2a9';
export const TENANT_ID = 'qube_assistant_tenant_b200_test_7';
...
export const TEST_AGENT_ID = 'agent_test_b200_bench008'; // Agent ID para o tenant
