...
import { randomString } from './utils-apikey-bench005-b200.js';
...
`;
  ...
  return `# Resultado do Teste de Carga: load-memorize-apikey (B200)
...
Este teste de carga avalia o desempenho do endpoint \`/memorize\` do servidor B200 sob carga moderada. Os resultados mostram como o servidor responde ao aumento gradual de usuários virtuais, permitindo analisar a escalabilidade e estabilidade do sistema.
