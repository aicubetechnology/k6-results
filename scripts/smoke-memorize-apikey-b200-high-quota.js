...
import { API_BASE_URL, getHeaders, getMemorizePayload, TENANT_ID } from './utils-apikey-b200-high-quota.js';
...
export function handleSummary(data) {
  ...
  const scriptName = 'smoke-memorize-apikey-high-quota';
...
`;
  ...
  return `# Resultado do Teste de Carga Massiva: smoke-memorize-apikey (B200 - Alta Quota)
...
Este teste utilizou um tenant com quota alta (1.000.000 requisições diárias) para evitar as limitações de quota encontradas em testes anteriores.
