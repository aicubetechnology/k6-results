...
import { API_BASE_URL, getHeaders, getMemorizePayload } from './utils-apikey-bench009-h100.js';
...
export function handleSummary(data) {
  ...
  const scriptName = 'stress-memorize-apikey-bench009-h100';
...
function generateSummaryMarkdown(data, timestamp) {
  ...
  return `# Resultado do Teste de Stress: stress-memorize-apikey-bench009-h100 (h100)

Data e hora: ${timestamp.toLocaleDateString()} ${timestamp.toLocaleTimeString()}

## Detalhes do Teste

* **Script:** stress-memorize-apikey-bench009-h100
