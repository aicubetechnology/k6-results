...
import { API_BASE_URL, getHeaders, getRetrievePayload, getMemorizePayload } from './utils-apikey-bench005-b200.js';
...
`;
  ...
  return `# Resultado do Teste de Fumaça: smoke-retrieve-apikey (B200)
...
Os resultados mostram o desempenho e a confiabilidade do servidor B200 ao processar requisições de recuperação de memórias.
`;
}