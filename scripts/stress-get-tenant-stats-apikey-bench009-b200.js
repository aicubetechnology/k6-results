...
import { API_BASE_URL, getHeaders, TENANT_ID } from './utils-apikey-bench009-b200.js';
...
export function handleSummary(data) {
  ...
  const scriptName = 'stress-get-tenant-stats-apikey-bench009-b200';
...
function generateSummaryMarkdown(data, timestamp) {
  ...
  return `# Resultado do Teste de Stress: stress-get-tenant-stats-apikey-bench009-b200 (b200)

Data e hora: ${timestamp.toLocaleDateString()} ${timestamp.toLocaleTimeString()}

## Detalhes do Teste

* **Script:** stress-get-tenant-stats-apikey-bench009-b200
